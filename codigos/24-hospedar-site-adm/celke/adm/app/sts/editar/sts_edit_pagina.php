                    ...
                    <div class="list-group-item">
                        <div class="d-flex">
                            <div class="mr-auto p-2">
                                <h2 class="display-4 titulo">Editar Página do site</h2>
                            </div>
                            <div class="p-2">
                                <span class = "d-none d-md-block">
                                    ...
                                    if ($btn_vis) {
                                        echo "<a href='" . pg . "/visualizar/sts_vis_pagina?id=" . $row_edit_pg['id'] . "' class='btn btn-outline-primary btn-sm'>Visualizar </a> ";
                                    }
                                    $btn_apagar = carregar_btn('processa/sts_apagar_pagina', $conn);
                                    if ($btn_apagar) {
                                        echo "<a href='" . pg . "/processa/sts_apagar_pagina?id=" . $row_edit_pg['id'] . "' class='btn btn-outline-danger btn-sm' data-confirm='Tem certeza de que deseja excluir o item selecionado?'>Apagar</a> ";
                                    }
                                    ?>
                                </span>
                                <div class="dropdown d-block d-md-none">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                        ...
                                        if ($btn_vis) {
                                            echo "<a class='dropdown-item' href='" . pg . "/visualizar/sts_vis_pagina?id=" . $row_edit_pg['id'] . "'>Visualizar</a>";
                                        }
                                        if ($btn_apagar) {
                                            echo "<a class='dropdown-item' href='" . pg . "/processa/sts_apagar_pagina?id=" . $row_edit_pg['id'] . "' data-confirm='Tem certeza de que deseja excluir o item selecionado?'>Apagar</a>";
                                        }
                                        ?>
                                    </div>
                                </div>
                        ...
                        ?>
                        <form method="POST" action="<?php echo pg; ?>/processa/proc_sts_edit_pagina" enctype="multipart/form-data">  
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="sts_robot_id" id="adms_robot_id" class="form-control">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="lib_bloq" id="lib_pub" class="form-control">
                                        <?php
                                        if ((isset($_SESSION['dados']['lib_bloq']) AND ( $_SESSION['dados']['lib_bloq'] == 1)) OR ( isset($row_edit_pg['lib_bloq']) AND ( $row_edit_pg['lib_bloq'] == 1))) {
                                            echo "<option value=''>Selecione</option>";
                                            echo "<option value='1' selected>Sim</option>";
                                            echo "<option value='2'>Não</option>";
                                        } elseif ((isset($_SESSION['dados']['lib_bloq']) AND ( $_SESSION['dados']['lib_bloq'] == 2)) OR ( isset($row_edit_pg['lib_bloq']) AND ( $row_edit_pg['lib_bloq'] == 2))) {
                                            echo "<option value=''>Selecione</option>";
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="sts_tps_pg_id" id="adms_tps_pg_id" class="form-control">
                                        <option value="">Selecione</option>
                                        <?php
                                        while ($row_tps_pgs = mysqli_fetch_assoc($resultado_tps_pgs)) {
                                            if (isset($_SESSION['dados']['sts_tps_pg_id']) AND ( $_SESSION['dados']['sts_tps_pg_id'] == $row_tps_pgs['id'])) {
                                                ...
                                                //Preencher com informações do banco de dados caso não tenha nenhum valor salvo na sessão $_SESSION['dados']
                                            } elseif (!isset($_SESSION['dados']['sts_tps_pg_id']) AND ( isset($row_edit_pg['sts_tps_pg_id']) AND ( $row_edit_pg['sts_tps_pg_id'] == $row_tps_pgs['id']))) {
                                                echo "<option value='" . $row_tps_pgs['id'] . "' selected>" . $row_tps_pgs['tipo'] . " - " . $row_tps_pgs['nome'] . "</option>";
                                            } else {
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="sts_situacaos_pg_id" id="depend_pg" class="form-control">
                                        <option value="">Selecione</option>
                                        <?php
                                        while ($row_sits_pgs = mysqli_fetch_assoc($resultado_sits_pgs)) {
                                            if (isset($_SESSION['dados']['sts_situacaos_pg_id']) AND ( $_SESSION['dados']['sts_situacaos_pg_id'] == $row_sits_pgs['id'])) {
                                                ...
                                                //Preencher com informações do banco de dados caso não tenha nenhum valor salvo na sessão $_SESSION['dados']
                                            } elseif (!isset($_SESSION['dados']['sts_situacaos_pg_id']) AND ( isset($row_edit_pg['sts_situacaos_pg_id']) AND ( $row_edit_pg['sts_situacaos_pg_id'] == $row_sits_pgs['id']))) {
                                                echo "<option value='" . $row_sits_pgs['id'] . "' selected>" . $row_sits_pgs['nome'] . "</option>";
                                            } else {
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    if (isset($row_edit_pg['imagem'])) {
                                       ...
                                       $imagem_antiga = pgsite.'/assets/imagens/paginas/preview_img.png'; 
                                    }
                                    ?>
